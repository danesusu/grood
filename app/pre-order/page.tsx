...
export default function PreOrderPage() {
  return (
    <main className="flex flex-col min-h-screen font-futura">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            <h1 className="text-4xl md:text-5xl font-bold">
              Pre-Order Your <span className="text-primary">Grood</span> Bike
            </h1>
            <p className="text-forground text-lg">
              Be among the first to experience the future of sustainable
              transportation. Fill out the form below to reserve your Grood bike
              today.
            </p>
          </div>
        </div>
